...
const Card = (props) => {
  return (
    <div className="bg-gray-dark w-72 text-white-primary rounded-lg">
      ...
      <div className="w-80 pl-3 pt-4">
        <h1 className=" text-left text-xl font-bold">{props.title}</h1>
        <h2 className=" text-left text-xl font-bold">{props.subtitle}</h2>
